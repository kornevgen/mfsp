...
должен быть либо равным `NULL`, либо указывать на некоторую память. Если
он не `NULL`, то в эту память функция записывает индекс: `from` -- это
первоначальный индекс ненулевого элемента, `to` -- это финальный индекс
ненулевого элемента.
